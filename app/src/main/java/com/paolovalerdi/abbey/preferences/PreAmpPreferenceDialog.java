...
public class PreAmpPreferenceDialog extends DialogFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        withRgValue = PreferenceUtil.INSTANCE.getReplayGainPreampWithTag();
        withoutRgValue = PreferenceUtil.INSTANCE.getReplayGainPreampWithoutTag();
        ...
        return new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton(android.R.string.ok, (dialog12, which) -> updateAndClose())
                .setView(view)
                .create();
    }

    private void updateAndClose() {
        PreferenceUtil.INSTANCE.setReplayGainPreamp(withRgValue, withoutRgValue);
        dismiss();
    }
