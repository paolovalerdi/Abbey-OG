...
import com.paolovalerdi.abbey.repository.ReplayGainTagExtractor;
...
public class Song implements Parcelable {
    ...
    public final String albumArtists;

    private float replaygainTrack = Float.NaN;
    private float replaygainAlbum = Float.NaN;

    public Song(int id, String title, int trackNumber, int year, long duration, String data, long dateAdded, long dateModified, int albumId, String albumName, int artistId, String artistName, String albumArtists) {
        this.id = id;
        this.title = title;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.albumArtists);
    }
    ...
    protected Song(Parcel in) {
        ...
        this.albumArtists = in.readString();
    }
