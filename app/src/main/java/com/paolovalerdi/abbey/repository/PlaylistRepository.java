...
public class PlaylistRepository {
    ...
    @NonNull
    public static ArrayList<Playlist> getAllPlaylistsWithSmartOnes(@NonNull final Context context) {
        ArrayList<Playlist> dataSet = new ArrayList<>();
        dataSet.add(new NotRecentlyPlayedPlaylist(context));
        dataSet.addAll(getAllPlaylists(makePlaylistCursor(context, null, null)));
        return dataSet;
    }
