...
interface DeezerRestService {
    ...
    companion object {
        ...
        operator fun invoke(client: okhttp3.Call.Factory): DeezerRestService = Retrofit.Builder()
            .baseUrl(BASE_URL)
            .callFactory(client)
        ...
        fun createDefaultOkHttpClient(context: Context): OkHttpClient.Builder = OkHttpClient.Builder()
        ...
        private fun createCacheControlInterceptor() = Interceptor { chain ->
