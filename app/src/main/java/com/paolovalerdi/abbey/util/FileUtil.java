...
import com.paolovalerdi.abbey.repository.SortedCursor;
...
public final class FileUtil {
    ...
    public static ArrayList<Song> matchFilesWithMediaStore(@NonNull Context context, @Nullable List<File> files) {
        return SongRepository.getSongs(makeSongCursor(context, files));
    }
    ...
    private static SortedCursor makeSongCursor(@NonNull final Context context, @Nullable final List<File> files) {
        ...
        Cursor songCursor = SongRepository.makeSongCursor(context, selection, selection == null ? null : paths);
    ...
    private static String readFromStream(InputStream is) throws Exception {
